...
int mpi_orth_mgs_lvl2_icwy_threesynch_append1(int mloc, int i, double *A, int lda, double *T, int ldt, double *r, MPI_Comm mpi_comm){
	...
	if( i == 0){
		...
		cblas_dtrsv( CblasColMajor, CblasUpper, CblasTrans, CblasNonUnit, i, T, ldt, &(r[0]), 1);
//		cblas_dtrsv( CblasColMajor, CblasLower, CblasNoTrans, CblasNonUnit, i, T, ldt, &(r[0]), 1);
...
//		cblas_dgemv(CblasColMajor, CblasTrans, mloc, i, (+1.0e00),  A, mloc, &(A[i*mloc]), 1, (+0.0e00), &(T[i]), ldt);
