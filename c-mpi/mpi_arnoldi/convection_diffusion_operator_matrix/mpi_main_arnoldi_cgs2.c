...
int main(int argc, char ** argv) {
	...
	mpi_orth_cgs2_threesynch_append1( mloc, 0, Q, mloc, &beta, work, MPI_COMM_WORLD);
	...
	for( j = 1 ; j < k+1 ; j++ ){
		...
		mpi_orth_cgs2_threesynch_append1( mloc, j, Q, mloc, H+(j-1)*(k+1), work, MPI_COMM_WORLD);
