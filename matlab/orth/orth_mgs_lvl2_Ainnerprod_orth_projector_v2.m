%
function [ mq, q, t, r ] = orth_mgs_lvl2_Ainnerprod_v2( M, MQ, Q, T, a )
%  
      m = size(Q,1);
      j = size(Q,2)+1;
%
...
%
      if j > 1
%
         r(1:j-1,1) = MQ(1:m,1:j-1)' * a(1:m,1);   
...
%
         ...
         t(j,1) = 1 / sqrt(1.0 - t(1:j-1,1)' * t(1:j-1,1));
         t(1:j-1,1) = - t(j,1) * T(1:j-1,1:j-1) * t(1:j-1,1);
%
      else
         t(j,1) = 1.0e+00;
      end   
